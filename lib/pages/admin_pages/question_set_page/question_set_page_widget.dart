...
class _QuestionSetPageWidgetState extends State<QuestionSetPageWidget> {
  late QuestionSetPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => QuestionSetPageModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'QuestionSetPage'});
        ...
        child: GestureDetector(
          ...
          child: Scaffold(
            ...
            floatingActionButton: FloatingActionButton.extended(
              onPressed: () async {
                logFirebaseEvent('QUESTION_SET_FloatingActionButton_gf0joa');
                setState(() {
                  FFAppState().questionSet = [];
                });

                context.pushNamed('QuestionAddPage');
              },
                            ...
                            child: Padding(
                              ...
                              child: StreamBuilder<List<QuestionSetsRecord>>(
                                stream: queryQuestionSetsRecord(
                                  queryBuilder: (questionSetsRecord) =>
                                      questionSetsRecord
                                          .where(
                                            'created_by',
                                  ...
                                  return ListView.separated(
                                    ...
                                    itemBuilder: (context, listViewIndex) {
                                      ...
                                      return InkWell(
                                        ...
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'QUESTION_SET_Container_5deccwnl_ON_TAP');
                                          setState(() {
                                            FFAppState().questionSet = [];
                                          });
                                          setState(() {
                                            FFAppState().questionSet =
                                                listViewQuestionSetsRecord
                                                    .questions
                                                    .toList()
                                                    .cast<QuestionStruct>();
                                          });
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    child:
                                        StreamBuilder<List<QuestionSetsRecord>>(
                                      stream: queryQuestionSetsRecord(
                                        queryBuilder: (questionSetsRecord) =>
                                            questionSetsRecord
                                                .where(
                                      ...
                                      builder: (context, snapshot) {
                                        ...
                                        List<QuestionSetsRecord>
                                            gridViewQuestionSetsRecordList =
                                            snapshot.data!;
                                        ...
                                        return GridView.builder(
                                          ...
                                          itemBuilder:
                                            ...
                                            final gridViewQuestionSetsRecord =
                                                gridViewQuestionSetsRecordList[
                                                    gridViewIndex];
                                            return InkWell(
                                              splashColor: Colors.transparent,
                                              ...
                                              onTap: () async {
                                                logFirebaseEvent(
                                                    'QUESTION_SET_Container_xw6108ag_ON_TAP');
                                                setState(() {
                                                  FFAppState().questionSet = [];
                                                });
                                                setState(() {
                                                  FFAppState().questionSet =
                                                      gridViewQuestionSetsRecord
                                                          .questions
                                                          .toList()
                                                          .cast<
                                                              QuestionStruct>();
