                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            Spacer(),
                            Image.asset(
                              'assets/images/trivia_logo_orange.png',
                              width: double.infinity,
                              height: 250.0,
                              fit: BoxFit.contain,
                            ).animateOnPageLoad(
                            ...
                            children: [
                              Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    0.0, 0.0, 0.0, 30.0),
                                child: TextFormField(
                                  controller: _model.nameFieldSmallController,
                                  focusNode: _model.nameFieldSmallFocusNode,
                              ...
                              Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    0.0, 0.0, 0.0, 30.0),
                                child: TextFormField(
                                  controller: _model.emailFieldSmallController,
                                  focusNode: _model.emailFieldSmallFocusNode,
                                      ...
                                      child: FFButtonWidget(
                                        onPressed: () async {
                                          ...
                                          await currentUserReference!
                                            ...
                                            displayName: _model
                                                .nameFieldSmallController.text,
                                            email: _model
                                                .emailFieldSmallController.text,
                                          ));
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Padding(
                                        ...
                                        child: TextFormField(
                                          controller:
                                              _model.nameFieldLargeController,
                                          focusNode:
                                              _model.nameFieldLargeFocusNode,
                                          textCapitalization:
                                      ...
                                      Padding(
                                        ...
                                        child: TextFormField(
                                          controller:
                                              _model.emailFieldLargeController,
                                          focusNode:
                                              _model.emailFieldLargeFocusNode,
                                          textInputAction: TextInputAction.done,
                                          obscureText: false,
                                          decoration: InputDecoration(
                                            labelText: 'Email',
